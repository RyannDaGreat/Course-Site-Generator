...
public class PropertiesManager
{
    ...
    {
        return getProperty(propType.toString());
    }
    ...
    {
        loadProperties(xmlDataFile,xmlSchemaFile,false);
    }
    public void loadProperties(String xmlDataFile,String xmlSchemaFile,boolean getRidOfDataPathBecauseRyanSaidSoToAvoidNullBullshit) throws InvalidXMLFileFormatException
    {
        String dataPath=getProperty(DATA_PATH_PROPERTY);
        if(!getRidOfDataPathBecauseRyanSaidSoToAvoidNullBullshit)
        {
            // ADD THE DATA PATH
