...
public class SeveralTabsBase extends VBox {
    ...
    public SeveralTabsBase() {
        ...
        button.setStyle("-fx-background-color: #e5d3ff;");
        ...
        imageView.setImage(getImage("Icons/Newcopy.png"));
        button.setGraphic(imageView);

        GridPane.setColumnIndex(button0, 1);
        button0.setMnemonicParsing(false);
        button0.setStyle("-fx-background-color: #e5d3ff;");
        ...
        imageView0.setImage(getImage("Icons/Foldercopy.png"));
        button0.setGraphic(imageView0);

        GridPane.setColumnIndex(button1, 2);
        button1.setMnemonicParsing(false);
        button1.setStyle("-fx-background-color: #e5d3ff;");
        ...
        imageView1.setImage(getImage("Icons/Floppycopy.png"));
        button1.setGraphic(imageView1);

        GridPane.setColumnIndex(button2, 3);
        button2.setMnemonicParsing(false);
        button2.setStyle("-fx-background-color: #e5d3ff;");
        ...
        imageView2.setImage(getImage("Icons/FloppyDowncopy.png"));
        button2.setGraphic(imageView2);

        GridPane.setColumnIndex(button3, 4);
        button3.setMnemonicParsing(false);
        button3.setStyle("-fx-background-color: #e5d3ff;");

        imageView3.setFitHeight(40.0);
        imageView3.setFitWidth(200.0);
        imageView3.setPickOnBounds(true);
        imageView3.setPreserveRatio(true);
        imageView3.setImage(getImage("Icons/Exportcopy.png"));
        ...
        button4.setStyle("-fx-background-color: #e5d3ff;");

        imageView4.setFitHeight(40.0);
        imageView4.setFitWidth(200.0);
        imageView4.setPickOnBounds(true);
        imageView4.setPreserveRatio(true);
        imageView4.setImage(getImage("Icons/Undocopy.png"));
        ...
        button5.setStyle("-fx-background-color: #e5d3ff;");

        imageView5.setFitHeight(40.0);
        imageView5.setFitWidth(200.0);
        imageView5.setPickOnBounds(true);
        imageView5.setPreserveRatio(true);
        imageView5.setImage(getImage("Icons/Redocopy.png"));
        ...
        button6.setStyle("-fx-background-color: #e5d3ff;");

        imageView6.setFitHeight(40.0);
        imageView6.setFitWidth(200.0);
        imageView6.setPickOnBounds(true);
        imageView6.setPreserveRatio(true);
        imageView6.setImage(getImage("Icons/Bookcopy.png"));
        ...
        textField.setStyle("-fx-background-color: #bddaed; -fx-background-radius: 30,30;");

        GridPane.setColumnIndex(textField0, 1);
        GridPane.setColumnSpan(textField0, 2147483647);
        GridPane.setRowIndex(textField0, 3);
        textField0.setPromptText("");
        textField0.setStyle("-fx-background-color: #bddaed; -fx-background-radius: 30,30;");
        ...
        textField1.setStyle("-fx-background-color: #bddaed; -fx-background-radius: 30,30;");

        GridPane.setColumnIndex(comboBox, 1);
        comboBox.setPrefWidth(150.0);
        comboBox.setPromptText("");
        comboBox.setStyle("-fx-background-color: #bddaed; -fx-background-radius: 30,30;");

        GridPane.setColumnIndex(comboBox0, 1);
        GridPane.setRowIndex(comboBox0, 1);
        comboBox0.setPrefWidth(150.0);
        comboBox0.setPromptText("");
        comboBox0.setStyle("-fx-background-color: #bddaed; -fx-background-radius: 30,30;");
        ...
        comboBox1.setStyle("-fx-background-color: #bddaed; -fx-background-radius: 30,30;");
        ...
        comboBox2.setStyle("-fx-background-color: #bddaed; -fx-background-radius: 30,30;");
        ...
        text9.setText("_ _ _ _ _ _ _ _ _ _ _ _");
        ...
        button7.setStyle("-fx-background-color: #bddaed; -fx-background-radius: 30,30;");
        ...
        button8.setStyle("-fx-background-color: #bddaed; -fx-background-radius: 30,30;");
        ...
        text12.setText("_ _ _ _ _ _ _ _ _ _ _ _");
        ...
        tableView.setStyle("-fx-background-color: #AABBCC; -fx-background-radius: 10,10;");
        tableView.getStylesheets().add("/_Experiments_/appstyle.css");
        ...
        text16.setText("Right Footer Image:");

        GridPane.setColumnIndex(button9, 2);
        GridPane.setHalignment(button9, javafx.geometry.HPos.RIGHT);
        button9.setMnemonicParsing(false);
        button9.setStyle("-fx-background-color: #bddaed; -fx-background-radius: 30,30;");
        ...
        imageView8.setImage(getImage("bannerimmage.png"));
        ...
        imageView9.setImage(getImage("bannerimmage.png"));
        ...
        button10.setStyle("-fx-background-color: #bddaed; -fx-background-radius: 30,30;");
        ...
        button11.setStyle("-fx-background-color: #bddaed; -fx-background-radius: 30,30;");
        ...
        comboBox3.setStyle("-fx-background-color: #bddaed; -fx-background-radius: 30,30;");
        ...
        tableView0.setStyle("-fx-background-color: #AABBCC; -fx-background-radius: 10,10;");
        tableView0.getStylesheets().add("/_Experiments_/appstyle.css");
        tableView0.setColumnResizePolicy(TableView.CONSTRAINED_RESIZE_POLICY);

        tableColumn3.setPrefWidth(75.0);
        tableColumn3.setText("Undergrad");
        ...
        textField2.setStyle("-fx-background-color: #bddaed; -fx-background-radius: 30,30;");

        GridPane.setColumnIndex(textField3, 1);
        GridPane.setColumnSpan(textField3, 2147483647);
        textField3.setPromptText("Name");
        textField3.setStyle("-fx-background-color: #bddaed; -fx-background-radius: 30,30;");

        GridPane.setRowIndex(button12, 2);
        button12.setMaxWidth(100.0);
        button12.setMinWidth(100.0);
        button12.setMnemonicParsing(false);
        button12.setStyle("-fx-background-color: #bddaed; -fx-background-radius: 30,30;");
        button12.setText("Add/Update");
        ...
        button13.setStyle("-fx-background-color: #bddaed; -fx-background-radius: 30,30;");
        ...
        tableView1.setStyle("-fx-background-color: #AABBCC; -fx-background-radius: 10,10;");
        tableView1.getStylesheets().add("/_Experiments_/appstyle.css");
        tableView1.setColumnResizePolicy(TableView.CONSTRAINED_RESIZE_POLICY);

        tableColumn6.setPrefWidth(75.0);
        tableColumn6.setText("Undergrad");

        tableColumn7.setPrefWidth(75.0);
        // tableColumn7.setStyle("-fx-background-color: #553366;");
        tableColumn7.setText("Name");

        tableColumn8.setPrefWidth(75.0);
        tableColumn8.setText("Email");
        ...
        comboBox4.setPromptText("Start Time");
        comboBox4.setStyle("-fx-background-color: #bddaed; -fx-background-radius: 30,30;");

        GridPane.setColumnIndex(comboBox5, 1);
        GridPane.setRowIndex(comboBox5, 1);
        comboBox5.setPrefWidth(150.0);
        comboBox5.setPromptText("End Time");
        comboBox5.setStyle("-fx-background-color: #bddaed; -fx-background-radius: 30,30;");
        ...
        tableView2.setStyle("-fx-background-color: #AABBCC; -fx-background-radius: 10,10;");
        tableView2.getStylesheets().add("/_Experiments_/appstyle.css");
        tableView2.setColumnResizePolicy(TableView.CONSTRAINED_RESIZE_POLICY);

        tableColumn9.setPrefWidth(75.0);
        tableColumn9.setText("Section");

        tableColumn10.setPrefWidth(75.0);
        // tableColumn10.setStyle("-fx-background-color: #553366;");
        tableColumn10.setText("Instructor");

        tableColumn11.setPrefWidth(75.0);
        tableColumn11.setText("Recitation Data");

        tableColumn12.setPrefWidth(75.0);
        tableColumn12.setText("TA");

        tableColumn13.setPrefWidth(75.0);
        tableColumn13.setText("TA");
        ...
        textField4.setStyle("-fx-background-color: #bddaed; -fx-background-radius: 30,30;");
        ...
        textField5.setStyle("-fx-background-color: #bddaed; -fx-background-radius: 30,30;");
        ...
        textField6.setStyle("-fx-background-color: #bddaed; -fx-background-radius: 30,30;");
        ...
        textField7.setStyle("-fx-background-color: #bddaed; -fx-background-radius: 30,30;");

        GridPane.setRowIndex(button14, 6);
        button14.setMaxWidth(100.0);
        button14.setMinWidth(100.0);
        button14.setMnemonicParsing(false);
        button14.setStyle("-fx-background-color: #bddaed; -fx-background-radius: 30,30;");
        button14.setText("Add/Update");
        ...
        button15.setStyle("-fx-background-color: #bddaed; -fx-background-radius: 30,30;");
        ...
        text1114.setText("Supervising TA:");
        ...
        datePicker.setStyle("-fx-background-color: bddaed; fx-background-radius: 30,30;");

        GridPane.setColumnIndex(datePicker0, 1);
        datePicker0.setStyle("-fx-background-color: bddaed; fx-background-radius: 30,30;");
        ...
        button17.setStyle("-fx-background-color: #bddaed; -fx-background-radius: 30,30;");
        ...
        datePicker1.setStyle("-fx-background-color: bddaed; fx-background-radius: 30,30;");
        ...
        tableView4.setStyle("-fx-background-color: #AABBCC; -fx-background-radius: 10,10;");
        tableView4.getStylesheets().add("/_Experiments_/appstyle.css");
        tableView4.setColumnResizePolicy(TableView.CONSTRAINED_RESIZE_POLICY);

        tableColumn18.setPrefWidth(75.0);
        tableColumn18.setText("Use");

        tableColumn19.setPrefWidth(75.0);
        // tableColumn19.setStyle("-fx-background-color: #553366;");
        tableColumn19.setText("Navbar Title");

        tableColumn110.setPrefWidth(75.0);
        tableColumn110.setText("File Name");

        tableColumn111.setPrefWidth(75.0);
        tableColumn111.setText("Script");
        ...
        textField13.setStyle("-fx-background-color: #bddaed; -fx-background-radius: 30,30;");

        GridPane.setColumnIndex(textField14, 1);
        GridPane.setColumnSpan(textField14, 2147483647);
        textField14.setStyle("-fx-background-color: #bddaed; -fx-background-radius: 30,30;");

        GridPane.setRowIndex(button18, 3);
        button18.setMaxWidth(100.0);
        button18.setMinWidth(100.0);
        button18.setMnemonicParsing(false);
        button18.setStyle("-fx-background-color: #bddaed; -fx-background-radius: 30,30;");
        button18.setText("Add/Update");
        ...
        button19.setStyle("-fx-background-color: #bddaed; -fx-background-radius: 30,30;");
        ...
        circle.setFill(javafx.scene.paint.Color.valueOf("#235399"));
        ...
        tableView5.setStyle("-fx-background-color: #AABBCC; -fx-background-radius: 10,10;");
        tableView5.getStylesheets().add("/_Experiments_/appstyle.css");
        tableView5.setColumnResizePolicy(TableView.CONSTRAINED_RESIZE_POLICY);

        tableColumn112.setPrefWidth(75.0);
        tableColumn112.setText("First Name");

        tableColumn113.setPrefWidth(75.0);
        // tableColumn113.setStyle("-fx-background-color: #553366;");
        tableColumn113.setText("Last Name");

        tableColumn114.setPrefWidth(75.0);
        tableColumn114.setText("Team");

        tableColumn115.setPrefWidth(75.0);
        tableColumn115.setText("Role");
        ...
        textField15.setStyle("-fx-background-color: #bddaed; -fx-background-radius: 30,30;");

        GridPane.setColumnIndex(textField16, 1);
        GridPane.setColumnSpan(textField16, 2147483647);
        textField16.setStyle("-fx-background-color: #bddaed; -fx-background-radius: 30,30;");
        ...
        button110.setStyle("-fx-background-color: #bddaed; -fx-background-radius: 30,30;");
        button110.setText("Add/Update");
        ...
        button111.setStyle("-fx-background-color: #bddaed; -fx-background-radius: 30,30;");
        button111.setText("Clear");
